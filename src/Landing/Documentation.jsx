...
export default function Documentation() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10 text-slate-800">
      ...
      <p className="mb-6">
        Welcome to <strong>Inside Invoice</strong>, a GST-compliant billing and
        invoice management platform built for Indian businesses.
      </p>
      ...
      <section className="mb-10">
        ...
        <h3 className="text-xl font-medium mt-4 mb-2">Edit / Delete Invoice</h3>
        <ul className="list-disc pl-6 space-y-2">
      ...
      {/* Customers */}
      <section className="mb-10">
        <h2 className="text-2xl font-semibold mb-3">👥 Customer Management</h2>
        <ul className="list-disc pl-6 space-y-2">
      ...
      {/* Payments */}
      <section className="mb-10">
        <h2 className="text-2xl font-semibold mb-3">💰 Payments & Tracking</h2>
        <ul className="list-disc pl-6 space-y-2">
      ...
      {/* Reports */}
      <section className="mb-10">
        <h2 className="text-2xl font-semibold mb-3">📊 Reports & Analytics</h2>
        <ul className="list-disc pl-6 space-y-2">
          <li>Sales reports</li>
          <li>GST summaries</li>
